...
MODEL_PATH = r"C:\Users\Keshav\Desktop\DS Course\Sem 4\3. AML\Assignment 03\Model"
...
def score(text: str, model: BaseEstimator, vectoriser, threshold: float = 0.5) -> Tuple[bool, float]:
